...
Debug.JustUpdateDeviceLine();
externalstorage.__c.runVoidMethod ("LogImpl","98257546",__ref.getField(true,"_persistanturi" /*RemoteObject*/ ),0);
...
Debug.JustUpdateDeviceLine();
externalstorage.__c.runVoidMethod ("LogImpl","97471114",RemoteObject.createImmutable("Can use persistant uri!"),0);
