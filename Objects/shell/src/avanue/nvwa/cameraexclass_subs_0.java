...
Debug.ShouldStop(8);
cameraexclass.__c.runVoidMethod ("LogImpl","76619140",RemoteObject.createImmutable("AutoFocus error."),0);
 };
...
cameraexclass.__c.runVoidMethod ("LogImpl","74390920",RemoteObject.concat(RemoteObject.createImmutable("success = false, "),cameraexclass.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
...
Debug.ShouldStop(67108864);
cameraexclass.__c.runVoidMethod ("LogImpl","77274501",BA.ObjectToString(_facerect),0);
 }
}Debug.locals.put("f", _f);
;
...
Debug.ShouldStop(64);
cameraexclass.__c.runVoidMethod ("LogImpl","74259844",RemoteObject.createImmutable("findCamera"),0);
...
cameraexclass.__c.runVoidMethod ("LogImpl","74259848",BA.ObjectToString(__ref.getField(false,"_r" /*RemoteObject*/ ).getField(false,"Target")),0);
 BA.debugLineNum = 44;BA.debugLine="Log(numberOfCameras)";
Debug.ShouldStop(2048);
cameraexclass.__c.runVoidMethod ("LogImpl","74259849",BA.NumberToString(_numberofcameras),0);
...
cameraexclass.__c.runVoidMethod ("LogImpl","74259854",RemoteObject.concat(RemoteObject.createImmutable("facing: "),__ref.getField(false,"_r" /*RemoteObject*/ ).runMethod(false,"GetField",(Object)(RemoteObject.createImmutable("facing"))),RemoteObject.createImmutable(", "),_cameravalue),0);
...
Debug.ShouldStop(1073741824);
cameraexclass.__c.runVoidMethod ("LogImpl","76225927",RemoteObject.createImmutable("Continuous focus mode is not available"),0);
 }}
;
...
Debug.ShouldStop(2048);
cameraexclass.__c.runVoidMethod ("LogImpl","74325392",BA.NumberToString(_previewresult),0);
 };
